          ...
          <div class="action-bar-tabs">
            ...
            <div class="agent-dropdown" v-if="profiles.length > 0">
              ...
              >
                ...
                <span>{{ selectedAgent ? selectedAgent.username : 'Chat with staff officers' }}</span>
              ...
              <div v-if="showAgentDropdown" class="dropdown-menu">
                ...
                >
                  ...
                  <div class="agent-info">
                    ...
                    <span class="agent-role">{{ agent.role_name || agent.profession || 'Staff Officer' }}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <span>Send survey to staff officers</span>
            </button>
          </div>
        </div>
        ...
        <div v-if="activeTab === 'chat'" class="chat-container">
          ...
          <div v-if="chatTarget === 'report_agent'" class="report-agent-tools-card">
            <div class="tools-card-header">
              ...
              <div class="tools-card-info">
                ...
                <div class="tools-card-subtitle">Fast conversational version of the Report Agent with 4 specialized tools and full ForumEngine memory</div>
              </div>
              ...
              <div class="tools-grid">
                <div class="tool-item tool-purple">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">Cross-references operational data with knowledge graph state, combining Global/Local Memory for deep multi-dimensional analysis</div>
                  </div>
                </div>
                <div class="tool-item tool-blue">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">PanoramaSearch Situation Overview</div>
                    <div class="tool-desc">Graph-based breadth-first traversal to reconstruct information flow paths and capture the full topology of the operational picture</div>
                  </div>
                </div>
                <div class="tool-item tool-orange">
                  ...
                  <div class="tool-content">
                    ...
                    <div class="tool-desc">GraphRAG instant query interface, optimized for fast retrieval of specific node attributes and discrete facts</div>
                  </div>
                </div>
                <div class="tool-item tool-green">
                  ...
                  <div class="tool-content">
                    <div class="tool-name">InterviewSubAgent Staff Interview</div>
                    <div class="tool-desc">Autonomous parallel interviews with staff officer agents to collect perspectives, assessments, and reasoning</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div v-if="chatTarget === 'agent' && selectedAgent" class="agent-profile-card">
            <div class="profile-card-header">
              ...
              <div class="profile-card-info">
                ...
                <div class="profile-card-meta">
                  ...
                  <span class="profile-card-profession">{{ selectedAgent.role_name || selectedAgent.profession || 'Staff Officer' }}</span>
                </div>
              </div>
            ...
            <div v-if="showFullProfile && selectedAgent.bio" class="profile-card-body">
              <div class="profile-card-bio">
                <div class="profile-card-label">Profile</div>
          ...
          <div class="chat-messages" ref="chatMessages">
            <div v-if="chatHistory.length === 0" class="chat-empty">
              ...
              <p class="empty-text">
                {{ chatTarget === 'report_agent' ? 'Chat with Report Agent to explore the tactical report' : 'Chat with staff officers to understand their assessments' }}
              </p>
            </div>
            <div 
          ...
          <div class="survey-setup">
              ...
              <div class="agents-grid">
                ...
                >
                  ...
                  <div class="checkbox-info">
                    ...
                    <span class="checkbox-role">{{ agent.role_name || agent.profession || 'Staff Officer' }}</span>
                  </div>
            ...
            <div class="setup-section">
              ...
              <textarea 
                ...
                class="survey-input"
                placeholder="Enter the question for selected staff officers..."
                rows="3"
              ></textarea>
            </div>
              ...
              >
                <div class="result-header">
                  ...
                  <div class="result-info">
                    ...
                    <span class="result-role">{{ result.role_name || result.profession || 'Staff Officer' }}</span>
                  </div>
                </div>
...
const chatHistoryCache = ref({}) // Cache all conversation histories: { 'report_agent': [], 'agent_0': [], 'agent_1': [], ... }
...
const sendToAgent = async (message) => {
  if (!selectedAgent.value || selectedAgentIndex.value === null) {
    throw new Error('Please select a staff officer first')
  }
  ...
  if (res.success && res.data) {
    // Parse response: supports both dict and array formats
    ...
    if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
      // Try agent key formats: "deliberation_N", "reddit_N", "twitter_N", or first value
      const agentResult = resultsDict[`deliberation_${agentId}`]
        || resultsDict[`reddit_${agentId}`]
        || resultsDict[`twitter_${agentId}`]
...
const submitSurvey = async () => {
  ...
  addLog(`Sending survey to ${selectedAgents.value.size} staff officers...`)
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      for (const interview of interviews) {
        ...
        if (typeof resultsDict === 'object' && !Array.isArray(resultsDict)) {
          const agentResult = resultsDict[`deliberation_${agentIdx}`]
            || resultsDict[`reddit_${agentIdx}`]
            || resultsDict[`twitter_${agentIdx}`]
          if (agentResult) {
...
const loadProfiles = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      addLog(`Loaded ${profiles.value.length} staff officers`)
    }
  } catch (err) {
    addLog(`Failed to load staff officers: ${err.message}`)
  }
}
