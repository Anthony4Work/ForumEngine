    ...
    <div class="scroll-container">
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 0, 'completed': currentPhase > 0 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            LLM analyzes document content and mission requirements to generate tactical ontology structure
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 1, 'completed': currentPhase > 1 }">
        ...
        <div class="card-content">
          ...
          <p class="description">
            Build knowledge graph from the generated ontology: auto-chunk documents, extract entities and relationships via Zep, and form temporal memory with community summaries
          </p>
      ...
      <div class="step-card" :class="{ 'active': currentPhase === 2, 'completed': currentPhase >= 2 }">
        ...
        <div class="card-content">
          ...
          <p class="description">Knowledge graph built. Proceed to set up the deliberation environment.</p>
          <button 
            class="action-btn" 
...
// Enter environment setup - create deliberation instance and navigate
const handleEnterEnvSetup = async () => {
  ...
  try {
    ...
    if (res.success && res.data?.simulation_id) {
      ...
      console.error('Failed to create deliberation:', res.error)
      alert('Failed to create deliberation: ' + (res.error || 'Unknown error'))
    }
  } catch (err) {
    console.error('Deliberation creation error:', err)
    alert('Deliberation creation error: ' + err.message)
  } finally {
