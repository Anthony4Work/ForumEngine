...
// Get maxRounds from query params at initialization to ensure child components receive it immediately
...
const handleGoBack = async () => {
  // Before returning to Step 2, stop the running simulation
  ...
  try {
    // Try graceful shutdown of the simulation environment first
